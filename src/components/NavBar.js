...
import  { FacebookIcon, TwitterIcon, GithubIcon, LinkedInIcon, SunIcon, MoonIcon } from './Icons'
  ...
  return (
    <header className='w-full px-32 py-8 font-medium flex items-center justify-between 
     dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8'>
        ...
        <button className='flex-col justify-center items-center 2xl:hidden xl:hidden lg:flex' onClick={handleClick} aria-label='hidden'>
       ...
       <motion.a href='https://www.facebook.com/bhuwan.stha.756' target={"_blank"}
          whileHover={{y:-2}}
          whileTap={{scale:0.9}}
          className='w-6 mr-3'
       >
