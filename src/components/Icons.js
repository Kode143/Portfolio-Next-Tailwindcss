...
viewBox="0 0 384 512"
    ...
    {...rest}
>
  <rect width="100%" height="100%" fill="yellow" /> {/* Yellow background */}
  <path d="M0 32l34.9 395.8L191.5 480l157.6-52.2L384 32H0zm308.2 127.9H124.4l4.1 49.4h175.6l-13.6 148.4-97.9 27v.3h-1.1l-98.7-27.3-6-75.8h47.7L138 320l53.5 14.5 53.7-14.5 6-62.2H84.3L71.5 112.2h241.1l-4.4 47.7z" />
  <text x="50%" y="50%" text-anchor="middle" fill="black" font-size="100">J</text> {/* Centered "J" letter */}
</svg>
...
<svg    width="3em"
    height="3em" viewBox="-10.5 -9.45 21 18.9"
    className={`w-full h-auto ${className}`}
    {...rest}
fill="none" xmlns="http://www.w3.org/2000/svg" class="text-sm me-0 w-10 h-10 text-link light-blue dark:text-link-dark flex origin-center transition-all ease-in-out">
...
export const PhpIcon = ({ className, ...rest }) => (
  <svg
    ...
    height="3em"
    viewBox="0 0 640 512"
    className={`w-full h-auto bg-white rounded-full ${className}`}
    {...rest}
  >
    <path
  ...
  export const ShopIcon = ({ className, ...rest }) => (
    <svg xmlns="http://www.w3.org/2000/svg"
    width="3em"
    height="3em"
    viewBox="0 0 576 512"
    ...
    >
      ...
      fill="orange" /> {/* Changed the fill color to orange */}
    </svg>
  );
...
height="3em" viewBox="0 0 512 512" >
  ...
  export const NodeIcon = ({ className, ...rest }) => (
    ...
    <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 448 512" height="3em"  width="3em"
...
export const Plogo = ({className, ...rest}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="1em"
    height="1em"
    viewBox="0 0 1000 992"
    {...rest}
  >
    <path d="M0 496v496h1000V0H0v496zm686.5-353c41.2 2 62.8 8.4 96.2 28.4 19.9 11.9 41.8 32.7 54.5 51.5 15.3 22.9 22.7 42.1 27.9 72.6 3.1 17.6 3.4 59 .6 76-4.2 25.5-7.7 37.4-16.6 56.1-7.9 16.4-14.9 26.7-27.8 40.9-11.3 12.4-18.9 19.1-32.9 28.8-4.5 3.1-8.4 6.3-8.7 7.1-.8 2.1.8 3.7 13.8 12.9 20.8 14.7 32.8 26.4 43.5 42.2 14.6 21.7 23.4 44.1 28.1 72 2 11.3 2.3 16.7 2.3 41.5 0 25.2-.2 30-2.2 41.5-4.2 23.8-7.4 33.8-16.8 52.6-10.3 20.7-28.3 42.6-49.8 60.8-22.7 19.2-51 32.9-84.1 40.7-10.7 2.5-12.2 2.6-62 3.5-28 .5-152.2.8-276 .7-217.9-.3-225.1-.4-228.8-2.2-4.6-2.3-10.3-8.7-11.9-13.5-1-2.8-1.3-74.7-1.4-317.1-.1-301.7.3-370.4 2.6-380.4 1.2-5.7 5-11.9 8.6-14.3 1.6-1 5.6-1.9 9.8-2.2 13.2-1.1 510.2-1.2 531.1-.1z" />
-7.8-89.5-.7-24.7-.9-26.2-3-29.9-1.6-2.7-2.5-6.4-3-11.4-.7-7.3-.8-7.6-3.7-8.4-4.7-1.3-23.4-3.7-40.7-5.3-13.4-1.2-16.8-1.9-23-4.5-4-1.7-8.8-4.5-10.5-6.3-3.2-3-4.3-7-2.3-8.2.5-.3 10.1.1 21.2 1 12.2 1 28.3 1.5 40.3 1.3l20-.3 1.2-6c.7-3.3 1.7-13.4 2.3-22.5 1-15.6 4.3-44.4 7.4-64.5.8-5 2.1-14.4 3-21 .9-6.6 2.5-16.5 3.6-22 3.1-16 3.1-16.3 1.4-18-1.7-1.7-7.1-1.9-12.4-.5-12.6 3.3-49.9 18-70 27.7-19.4 9.3-23.4 10.3-29.5 7.3-11.9-5.8-18.2-20.8-14.2-34.1 3.8-12.7 19.3-29.1 40.4-43 24.7-16.2 63-33.3 84.8-37.8 9.6-2 12.3-3.2 13-5.8.3-1.3 1.7-4.8 3-7.8 1.4-2.9 2.5-6 2.5-6.7 0-1.8 5.5-12.8 7.7-15.5 4.2-4.9 20.8-10.7 27.2-9.5 1.4.3 3.9 1.5 5.4 2.6z" />
    <path d="M595.5 293.5c-20.1 1.5-42 3.9-60 6.5-7.1 1.1-21.1 3.1-31 4.5-9.9 1.4-21.6 3-26 3.6-9.7 1.4-19.8 4.4-21.4 6.3-.7.8-1.6 7.5-2.1 15.3-.5 7.6-1.4 17.2-2 21.3-3.4 23.2-6.9 55.1-8.9 83-.6 8-1.6 20.3-2.3 27.3-1 10.9-.9 13 .3 13.8 2.1 1.5 14.8.2 27.4-2.8 36-8.4 39.6-9.4 65.1-18.2 12.6-4.3 24-8.3 25.4-8.9 10.6-4.5 44.6-20.1 53.5-24.5 6.1-3 14.8-7.3 19.5-9.5 13.6-6.6 28.1-14.6 49-27.2 44.8-27 66-44.2 66-53.6 0-15.1-44.1-34.4-85.9-37.4-16.9-1.3-45.8-1-66.6.5zM441.6 531c-7.7 1.4-7.6 1.2-7.6 8.7-.1 3.7-.5 9.7-1 13.3-1.1 8.1-3.6 27.7-5.5 43.2-.8 6.4-2.2 20.8-3 32-.9 11.2-2.2 25.2-3 31.2-2.1 15.4-2.1 27 0 30.3 1.7 2.5 1.9 2.6 9.9 2 13.7-1.1 34.6-6.4 53.3-13.6 15.6-6.1 74.9-32.8 108.2-48.8 32.4-15.7 65.7-38 73.1-49.1 3.5-5.4 3.6-5.7 1-9.9-6.5-10.7-30.2-22.1-57.8-27.8-4-.8-8.2-2-9.3-2.5-1.1-.6-10.6-1.7-21.2-2.5-10.5-.8-23.2-2-28.2-2.6-22.5-2.7-99.4-5.5-108.9-3.9z" />
  </svg>
)
