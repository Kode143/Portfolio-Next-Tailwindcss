...
const HireMe = () => {
  return (
    ...
    flex items-center justify-center overflow-hidden md:right-0 md:left-auto md:top-0 md:bottom-auto md:absolute lg:right-0 lg:left-auto lg:top-0 lg:bottom-auto lg:absolute
    sm:right-0'>
